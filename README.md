...
1.  Клонируйте репозиторий:
    ```bash
    git clone git@github.com:Diesto070/Atomic_Habits_Project.git
    cd Atomic_Habits_Project
    ```
...
7.  Для работы напоминаний и отложенных задач, запустите Celery worker:
    ...
    poetry run celery -A Atomic-Habits-Project.celery worker -l info
    ```
